...
ki = SHIZUKA.LINE()
ki.login(token="Auth Token")
ki.loginResult()

ki2 = SHIZUKA.LINE()
ki2.login(token="Auth Token")
ki2.loginResult()

ki3 = SHIZUKA.LINE()
ki3.login(token="Auth Token")
ki3.loginResult()

ki4 = SHIZUKA.LINE()
ki4.login(token="Auth Token")
ki4.loginResult()

ki5 = SHIZUKA.LINE()
ki5.login(token="Auth Token")
ki5.loginResult()

ki6 = SHIZUKA.LINE()
ki6.login(token="Auth Token")
ki6.loginResult()

ki7 = SHIZUKA.LINE()
ki7.login(token="Auth Token")
ki7.loginResult()

ki8 = SHIZUKA.LINE()
ki8.login(token="Auth Token")
ki8.loginResult()

ki9 = SHIZUKA.LINE()
ki9.login(token="Auth Token")
ki9.loginResult()
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                if wait["commentOn"] == True: md+="༒ Auto komentar:on 􀜁􀄯􏿿\n"
                else:md+="༒ Auto komentar:off 􀜁􀄰􏿿\n"
...
#-------------------------------------------------------------
                ...
                with requests.session() as s:
                    ...
                    url    = 'http://www.youtube.com/result'
                    ...
                    for a in soup.select('.yt-lockup-title > a[title]'):
                        if  '&list=' not in a['href']:
                         ...
                         #print('http://www.youtube.com'  +  a['href'],  a['titke'])
 ...
 #------------------------------------------------------------------
              ...
              if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"􀜁􀇔􏿿Maaf grup anda kami sita")
                    targets = []
                    for g in gs.members:
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            ki7.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ༺ S̴̥̦̙͖̘͎͇ͩ̽ͥ͂̏ͅH͔̺͖̞̒̿́̋͋I̡͖͇̮̥̩̋̓ͥ̌̇̀Z̛͓͈̼͔̗̠̮͖̀͂ͣ̔͂̐̓͢͞U͕̱̹̯̮͈͉͙͒ͪ͗ͨ̿͐̐̎́K̴̨̟̟̞ͯͧȂ̡̖̳̼͕̟̳̲̙ͨ͒͌̄̀͟A̢̛̩̙̹͍̪͕͕͍̅̄ͤ͑̐̉͐̇ ̸͛̒ͨ��̲͙��͙̘̠͎̥B͉͖̬̦̙̘̗͈̤ͫ͑̉ͪ̇̊̂̀̚̕O̢͈͕͕͔̲̫͈̦̣͗̃͋̆̌̎ͣ̕T̪̬͖͓̗̖ͯ̔ͦ̅̒͝ ༻\n\n-> http://line.me/ti/p/gdxaOTAn1v")
