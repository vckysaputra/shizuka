...
ki11 = SHIZUKA.LINE()
ki11.login(token="EmeR98hJgDix2fwSzdW4.1XX4LconJlpaN7x2NacqDa.ab3NbfdEVXLbECK4BWPcWySwZ7TLq99SNwHLJwrr7ZQ=")
ki11.loginResult()

ki12 = SHIZUKA.LINE()
ki12.login(token="EmamB6T0Za79ME5aijB9.OHHgf2H/bNIX/EbFOo9k6q.xauRV9E9s5uE+/I5n5kcG7AEEQd8GHfFukgs3L2dkQI=")
ki12.loginResult()

ki13 = SHIZUKA.LINE()
ki13.login(token="EmYjMTHo3BkGmA2NFZre.1HMpxpFSXS6WjtzBnij2VG.D0BP9nrMGZM8xupjVOb3g9PFym5bOtMRAyoxMrw/oiU=")
ki13.loginResult()

ki14 = SHIZUKA.LINE()
ki14.login(token="Em6uxcjsMuiegjkzosod.d2yUkZ4LHXkMMNxZG/ouxq.ha9EnRTKAp31Dg03XIJpYp3sFgKVT5hUjUh0sa/NAwU=")
ki14.loginResult()

ki15 = SHIZUKA.LINE()
ki15.login(token="Em6uxcjsMuiegjkzosod.d2yUkZ4LHXkMMNxZG/ouxq.ha9EnRTKAp31Dg03XIJpYp3sFgKVT5hUjUh0sa/NAwU=")
ki15.loginResult()
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        cl.sendText(msg.to,"Done👈")
                elif wait["whitelist"] == True:
                    if msg.contentMetadata["mid"] in wait["whitelist"]:
                        del wait["whitelist"][msg.contentMetadata["mid"]]
                        cl.sendText(msg.to,"Done👈")
                        wait["whitelist"] = False
                    else:
                        wait["whitelist"] = False
                        cl.sendText(msg.to,"Done👈")
              ...
              if msg.from_ in admin:
                ...
                if wait["inviteprotect"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already openc👈")
                ...
                md = ""
                md+="\n"
                md+="   ༺ S̴̥̦̙͖̘͎͇ͩ̽ͥ͂̏ͅH͔̺͖̞̒̿́̋͋I̡͖͇̮̥̩̋̓ͥ̌̇̀Z̛͓͈̼͔̗̠̮͖̀͂ͣ̔͂̐̓͢͞U͕̱̹̯̮͈͉͙͒ͪ͗ͨ̿͐̐̎́K̴̨̟̟̞ͯͧȂ̡̖̳̼͕̟̳̲̙ͨ͒͌̄̀͟A̢̛̩̙̹͍̪͕͕͍̅̄ͤ͑̐̉͐̇ ̸̲͙͈͙̘̠͎̥͛̒ͨ͡B͉͖̬̦̙̘̗͈̤ͫ͑̉ͪ̇̊̂̀̚̕O̢͈͕͕͔̲̫͈̦̣͗̃͋̆̌̎ͣ̕T̪̬͖͓̗̖ͯ̔ͦ̅̒͝ ༻\n\n\n"
                if wait["contact"] == True: md+="༒ Contact:on 🔒\n"
                else: md+="༒ Contact:off 🔓\n"
                if wait["autoJoin"] == True: md+="༒ Auto Join:off 🔒\n"
                ...
                for i in gid:
                    ...
                    ki15.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ShizukaBot Sudah Keluar Di semua grup 🐇")
                else:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                klist=[ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
